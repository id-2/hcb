...
incoming_fees_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: false
).find_or_create_by!(slug: "incoming-fees")
...
noevent_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: false
).find_or_create_by!(slug: "noevent")
...
hackathon_grant_fund_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "hackathon-grant-fund")
...
winter_hardware_wonderland_grant_fund_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "winter-hardware-wonderland")
...
argosy_grant_fund_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "argosy-foundation-grant")
...
first_transparency_grant_fund_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "transparency-grant-fund")
...
hack_foundation_interest_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "hack-foundation-interest-earnings")
...
reimbursement_clearing_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "reimbursement-clearinghouse")
...
svb_sweeps_event = Event.create_with(
  ...
  created_at: 14.days.ago,
  is_public: true
).find_or_create_by!(slug: "hcb-sweeps")
