  ...
  def show
    ...
    if @event.demo_mode? && session[:show_mock_data]
      mock_transaction_descriptions = [
        ...
        { desc: "😨 Monthly payment to the local protection racket", amount: -2500.00 },
        ...
        { desc: "💰 Donation from the man in the walls", amount: 1_200.00 },
        ...
        { desc: "🌸 Payment for a floral arrangement", amount: -15.50 },
        { desc: "🧼 Purchase of eco-friendly soap for the club bathrooms", amount: -7.49 },
        { desc: "💰 Donation from Dave from next door", amount: 250.00 },
