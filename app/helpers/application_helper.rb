...
module ApplicationHelper
  ...
  def blankslate(text, options = {})
    ...
    content_tag(:p, text, class: "center mt0 mb0 pt4 pb4 muted font-medium h3 w-full rounded border #{options[:class]}", **other_options)
  end
  ...
  def modal_header(text, external_link: nil, &block)
