...
Rails.application.routes.draw do
  ...
  resources :events, except: [:new, :create], path_names: { edit: "settings" }, path: "/" do
    ...
    resources :organizer_positions, path: "team", as: "organizer", only: [] do
      ...
      resources :controls, path: "spending/controls", controller: "organizer_position/spending/controls"
      resources :allowances, path: "spending/allowances", controller: "organizer_position/spending/allowances", only: [:new]
    end
